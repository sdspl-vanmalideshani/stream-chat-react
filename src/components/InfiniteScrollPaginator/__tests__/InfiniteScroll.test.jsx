...
const loadMore = vi.fn().mockImplementation(() => Promise.resolve());
...
describe('InfiniteScroll', () => {
  ...
  const divAddEventListenerSpy = vi.spyOn(HTMLDivElement.prototype, 'addEventListener');

  const divRemoveEventListenerSpy = vi.spyOn(HTMLDivElement.prototype, 'addEventListener');
