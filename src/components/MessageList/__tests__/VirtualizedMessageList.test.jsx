...
vi.mock('react-virtuoso', async () => {
  const { Virtuoso } = await vi.importActual('react-virtuoso');
  return {
...
vi.mock('../../Loading', async () => {
  const Loading = await vi.importActual('../../Loading');
...
vi.mock('../../Message', async () => {
  const Message = await vi.importActual('../../Message');

  return {
    ...Message,
    FixedHeightMessage: vi.fn(({ groupedByUser }) => (
      <div data-testid='msg'>
