  ...
  describe('video type attachment', () => {
    ...
    it('should render video player if video type is video', async () => {
      const attachment = generateVideoAttachment({
        ...
        text: "It's Gmod TTT! Praise Ben in the church of Bon! Hail the great jetstream in Gmod TTT! Confused? Check out the new roles here: https://twitter.com/yogscast/st...",
